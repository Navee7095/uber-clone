resource "aws_eks_cluster" "my_cluster" {
  name     = "my-cluster-1"
  role_arn = "arn:aws:iam::471112501164:role/admin-full"  # Replace with your IAM role ARN
...
resource "aws_eks_node_group" "my_node_group" {
  ...
  node_role_arn   = "arn:aws:iam::471112501164:role/admin-full"  # Replace with your IAM role ARN
  subnet_ids      = ["subnet-0fac716e4e1c6c227", "subnet-0021745e2c2b844f2"]      # Replace with your subnet IDs
